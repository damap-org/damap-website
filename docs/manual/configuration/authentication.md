...
|:-----------------------------------| :-------------------------------------------------------------------- |:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `QUARKUS_OIDC_AUTH_SERVER_URL`     | `http://keycloak:8080/realms/damap`                                   | The web address of your login server. DAMAP uses this to verify that a user's login is genuine.                                                                              |
